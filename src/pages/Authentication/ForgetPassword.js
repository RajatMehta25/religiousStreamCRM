...
class ForgetPasswordPage extends Component {
  ...
  async handleValidSubmit(event,values) {
    ...
    let requestData = {
        email : this.props.forgetUser(values, this.props.history).payload.user.useremail,
    }
    try {
    ...
    return (
      <React.Fragment>
        <div className="home-btn d-none d-sm-block">
            <Link to="/adminPanel/"><i className="mdi mdi-home-variant h2 text-white"></i></Link>
        </div>
        <div>
                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Enter your registered email here, we will send you the link to reset your password.</p>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                <p>Return to<Link to="/adminPanel/login" className="font-weight-medium text-primary"> LogIn </Link> </p>
                                                <p>© 2022 Live Adhan.</p>
                                            </div>
                                        </div>
